...
/**
 * Clasa ViewProduct: este clasa in care se realizeaza partea grafica pentru selectarea operatiilor din tabelul product si efectuarea acestora.
 */

public class ViewProduct extends JFrame{
    private JLabel label1=new JLabel("Selectati operatia:",SwingConstants.CENTER);
    private JLabel label2=new JLabel("Intoduceti ID-ul produsului",SwingConstants.CENTER);
    private JLabel label3=new JLabel("Intoduceti noua cantitate a produsului",SwingConstants.CENTER);
    private JLabel label4=new JLabel("Intoduceti noul pret al produsului",SwingConstants.CENTER);
    private JLabel label5=new JLabel("Intoduceti numele produsului",SwingConstants.CENTER);
    private JLabel label6=new JLabel("Intoduceti cantitatea produsului",SwingConstants.CENTER);
    private JLabel label7=new JLabel("Intoduceti pretul produsului",SwingConstants.CENTER);
    private JLabel emptyLabel1=new JLabel("");
    private JRadioButton button2=new JRadioButton("Stergere produs dupa id");
    private JRadioButton button3=new JRadioButton("Actualizare produs");
    private JRadioButton button4=new JRadioButton("Afisare produse");
    private JRadioButton button5=new JRadioButton("Introducere produs");
